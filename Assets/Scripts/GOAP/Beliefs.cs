...
public class BeliefFactory
{
    ...
    {
        AddLocationBelief(key, distance, locationCondition.transform.position);
    }
    ...
    bool InRangeOf(Vector3 pos, float range) => Vector3.SqrMagnitude(pos - agent.transform.position) < range * range;
}
...
public class AgentBelief
{
    ...
    Func<Vector3> observeredLocation = () => Vector3.zero;

    public Vector3 Location => observeredLocation();
    ...
    public class Builder
    {
        ...
        {
            belief.observeredLocation = observedLocation;
            return this;
        }
